    	...
    	function cPlugin(o,emlnum){
    		var sjObj=o;
		        ...
		        sjObj.defaults={
		            ...
		            mArr:[],//分钟数组
		            sArr:[],//分钟数组
		            yyyy:new Date().getFullYear(),//当前显示年
		            mm:new Date().getFullYear()+"-"+(new Date().getMonth() + 1) < 10 ? '0' + (new Date().getMonth() + 1) : (new Date().getMonth() + 1),//当前显示月
		            dd:new Date().getFullYear()+"-"+(new Date().getMonth() + 1) < 10 ? '0' + (new Date().getMonth() + 1) : (new Date().getMonth() + 1)+"-"+ new Date().getDate() < 10 ? '0' + new Date().getDate() : new Date().getDate(),//当前显示日
		            h:"01",//当前显示小时
		            m:"01",//当前显示分
		            s:"01",//当前显示秒
		            val:null,//最终显示时间
		            // yearText:"年",//顶部时间 年单位 文字  //如果想要给没一个都追加文字，就把这里的注释掉，在185行追加
		            ...
		            strStart:function(text,c){
		                ...
		                //console.log(this);
		                if(df.width){
		                    str='<div class="df-class">'+text+'</div><div class="df-item " style="height:'+(df.height*5)+'px"><ul class="df-ul" data-class='+c+'>';
		                }else{
		                    str='<div class="df-class">'+text+'</div><div class="df-item " style="height:'+(df.height*5)+'px"><ul class="df-ul" data-class='+c+'>';
		                }
		                sjObj.opt.dataNum++;
		            ...
		            buildArrStr:function(Arr,txt,c){
		                ...
		                $.each(Arr,function(){
                           if(c=="yyyy"){
							   str+='<li class="df-li df-show"  data-val='+sjObj.opt.fillZero(this)+' style="line-height:'+sjObj.opt.height+'px;height:'+sjObj.opt.height+'px">'+sjObj.opt.fillZero(this)+'年</li>'
						   }else if(c=="mm"){
							   str+='<li class="df-li df-show"  data-val='+sjObj.opt.fillZero(this)+' style="line-height:'+sjObj.opt.height+'px;height:'+sjObj.opt.height+'px">'+sjObj.opt.fillZero(this)+'月</li>'
						   }
		                });
		                //console.log(Arr)
		            ...
		            buildHTml:function(){
		                ...
		                if(sjObj.opt.alwaysShow){
                          ...
                          if(prevText=="前一月"){
                            $('#monthPanel').append(sjObj.opt.timeElm)
                          }else if(prevText=="前一年"){
                            $('#yearPanel').append(sjObj.opt.timeElm)
                          }
		            ...
		            bindFun:function(){
		                ...
		                sjObj.opt.timeElm.find(".df-ok").on("click",function(){
		                    ...
		                    if(sjObj.opt.Month) {
                            var m = sjObj.opt.mm;//月份两位和一位的都会返回，比如：05 和 5 这种
                            if(m.toString().length > 0 && m.toString().length <=1){
                              str = str.replace("mm", sjObj.opt.mm < 10?'0'+sjObj.opt.mm:sjObj.opt.mm);//月份只有一位
                            }else{
                        ...
                        var ym="";
                        if(text=="前一月"){
                            ym= str.trim().substr(0,7);
                        }else if(text=="前一年"){
                          ym = str.trim().substr(0,4);
                        }
		                    //console.log("==="+ym);
		                    sjObj.opt.val=ym;
                        ...
                        if(text=="前一月"){
                          queryDataBydate(GDateType.MONTH, $("#month").val().trim(), area);
                        }else if(text=="前一年"){
                          queryDataBydate(GDateType.YEAR, $("#year").val().trim(), area);
                        }
		            ...
		            fillData:function(){
		                ...
		                if(sjObj.opt.Month){
		                    str+=sjObj.opt.mm;//隐藏在页面的日期，把间隔符改成 汉字
		                }
		                // if(sjObj.opt.Day){
		                //     str+=sjObj.opt.dd;
		                // }

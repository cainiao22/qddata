...
<header>
    <nav>
        ...
        <div class="tabControl">
            <a href="./versionAnalyse"><div data-type="0"><i class="qdLogo_n"></i>千丁App</div></a>
            <a href="./versionAnalyse_dgj"><div data-type="1" class="active"><i class="dgjLogo"></i>丁管家</div></a>
        </div>
    </nav>
</header>
    <!--leftBar begin-->
    ...
    <div class="scrollnav">
        <div class="leftPanel">
            ...
            <li>
                ...
                <a href="./versionAnalyse_dgj"><div class="level active">版本分析</div></a>
            </li>
            <li>
            ...
            <div class="main" id="dgjPanel">
                <div class="titlePanel">
                    <div class="title">
                        ...
                        <div>
                            <label>物业公司:</label>
                            <select style="min-width: 120px" class="select2" id="property" onchange="tableShow('1')">
                                <option value="all" selected>全部</option>
                            </select>
                            <label style="margin-left: 20px;">端:</label>
                            <select id="appType" onchange="tableShow('1')">
                ...
                <div class="tableInfo">
                    ...
                    <div class="col-md-12" >
                        <table id="dgj_fenxi" class="table cell-border" style="white-space: nowrap;">
                            <thead><tr><td style="border-left: 1px solid #dee2e6">软件版本</td><td>使用人数</td><td>占比</td></tr></thead>
                            <tbody></tbody>
                        </table>
                    </div>
                </div>

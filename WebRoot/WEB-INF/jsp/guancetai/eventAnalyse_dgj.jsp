...
<header>
    <nav>
        ...
        <div class="tabControl">
            <a href="./eventAnalyse"><div data-type="0"><i class="qdLogo_n"></i>千丁App</div></a>
            <a href="./eventAnalyse_dgj"><div data-type="1" class="active"><i class="dgjLogo"></i>丁管家</div></a>
        </div>
    </nav>
</header>
	<!--leftBar begin-->
<aside id="sidenav">
    <div class="scrollnav">
        ...
        <li class="chose">
            ...
            <a href="./eventAnalyse_dgj"><div class="level active">事件分析</div></a>
			...
			<div class="main" id="dgjPanel">
				...
				<div class="chartInfo">
					<div class="title">
						...
						<div style="float: left;margin-left: 10px">
							<select style="margin-right: 20px;" id="dgj_eventname" class="select2" onchange="evevtnamechoose()">
								<option value="all" selected>全部</option>
							</select>
						</div>
						<div>
							<label>端:</label>
							<select style="margin-right: 20px;" id="dgj_appType_qst" onchange="qushituSelect()">
				...
				<div class="tableInfo">
					<div class="tableTyple">
						<div class="tab dgj_tab_2">
							<div class="bg_active">汇总统计</div><div>详情统计</div>
						</div>
						<div class="download" onclick="getExportDate()">下载</div>
					</div>
					<div class="col-md-12">
						<table id="dgj_example" class="table cell-border" style="white-space: nowrap;">
							<thead>
							<tr>
						...
						<table id="dgj_example_detail" class="table cell-border" style="white-space: nowrap;display: none">
							<thead>
							<tr>

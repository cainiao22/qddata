...
<header>
    <nav>
        ...
        <div class="tabControl">
            ...
            <a href="./osAnalyse_dgj"><div data-type="1" class="active"><i class="dgjLogo"></i>丁管家</div></a>
        </div>
    </nav>
</header>
    <!--leftBar begin-->
    ...
    <div class="scrollnav">
        <div class="leftPanel">
            ...
            <li>
                ...
                <a href="./osAnalyse_dgj"><div class="level active">操作系统</div></a>
        ...
        <div class="controller">
            <div class="main" id="dgjPanel">
                ...
                <div class="tableInfo">
                    ...
                    <div class="col-md-12" >
                        <table id="dgj_os" class="table cell-border" style="white-space: nowrap;">
                            <thead><tr><td style="border-left: 1px solid #dee2e6">操作系统版本</td><td>使用人数</td><td>占比</td></tr></thead>
                            <tbody></tbody>
                        </table>
                    </div>
                </div>
...
<script>
    ...
    function tableShow() {
        ...
        var urls = getLocation() + proxy("/dataApiQuery/gct_table_device_version_1",param);
...
//		     "autoWidth": true,//自动列宽
    ...
    function getExportData(){
        ...
        var param={
            "source":appType,
            "lessee_name":property?(property=='-1'?'all':property):'all'
        }
        var title = {
            "system_version": '操作系统版本',
            "use_device_count": '使用人数',
            "per_use_count":'占比',
        };
        postDownLoadFile({
            url: './dataApiExport/gct_table_device_version_1',
            data: {
                "params":param,
                "titles":title
            },

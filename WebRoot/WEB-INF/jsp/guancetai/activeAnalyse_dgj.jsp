    ...
    <nav>
        ...
        <div class="tabControl">
            <a href="./activeAnalyse">
                <div data-type="0"><i class="qdLogo_n"></i>千丁App</div>
            </a>
            <a href="./activeAnalyse_dgj">
                <div data-type="1" class="active"><i class="dgjLogo"></i>丁管家</div>
            </a>
        </div>
    </nav>
</header>
            ...
            <nav>
                <ul id="sidebar">
                    ...
                    <li>
                        ...
                        <a href="./eventAnalyse_dgj">
                            <div class="level">事件分析</div>
                        </a>
                        <a href="./pathAnalyse_dgj">
                    ...
                    <li>
                        ...
                        <a href="./osAnalyse_dgj">
                            <div class="level">操作系统</div>
                        </a>
                        <a href="./clientType_dgj">
                            <div class="level">终端型号</div>
                        </a>
                    </li>
                </ul>
            </nav>
...
<div>
    <div class="mouseShow mouseShow1">
        <div>基本统计</div>
        <div class="twoLevel"><a href="./guancetai_dgj">
    ...
    <div class="mouseShow mouseShow2">
        ...
        <div class="twoLevel" style="margin-left: 0">
            ...
            <a href="./louDouAnalyse_dgj">
                <div class="menu">漏斗分析</div></a>
        </div>
    </div>
    ...
    <div class="mouseShow mouseShow5">
        ...
        <div class="twoLevel" style="margin-left: 0">
            <a href="./osAnalyse_dgj">
                <div class="menu">操作系统</div>
            </a>
            <a href="./clientType_dgj">
                <div class="menu">终端型号</div>
            </a>
        </div>
    </div>
</div>
...
<div class="wrapper">
    ...
    <div class="controller">
        <div class="main" id="qdingPanel">
            <div class="chartInfo">
                <div class="title">
                    ...
                    <div style="position: relative">
                        <%--<label>物业公司:</label>--%>
                            <%--<select style="min-width: 120px" class="select2" id="property" onchange="tableShow('1'),test()">--%>
                                <%--<option value="all" selected>全部</option>--%>
                            <%--</select>--%>
                        <label>端:</label>
                        <select style="margin-right: 20px;" id="appType_qst"
                                onchange="dataStatisticSelect(1);dataStatisticSelect1()">
                            <option value="all">全部端</option>
                            <option value="Android">Android</option>
                            <option value="iOS">IOS</option>
                        </select>
                        <label class="userText">用户类型:</label>
                        <select style="margin-right: 20px;" id="userType_qst"
                                onchange="dataStatisticSelect(1);dataStatisticSelect2()">
                            <option value="2">全部用户</option>
                            <option value="0">未登录</option>
                            <option value="1">已登录</option>
                        </select>
                        <label>时间类型:</label>
                        <select style="margin-right: 20px;" id="dateType_qst"
                                onchange="dataStatisticSelect(1);dataStatisticSelect3()">
            ...
            <div class="tableInfo">
                <div class="title" style="border-bottom: 1px solid #EBF1F5;" id="title">
                    <div>用户活跃详情</div>
                    <div>
                        <label>端:</label>
                        ...
                        <label>时间:</label>
                        <div class="c-datepicker-date-editor  J-datepicker-range-day setdate-2" style="display: none;">
                            <i class="c-datepicker-range__icon kxiconfont icon-clock"></i>
                            <input placeholder="开始日期" name="" class="c-datepicker-data-input only-date" value="">
                            <span class="c-datepicker-range-separator">-</span>
                            <input placeholder="结束日期" name="" class="c-datepicker-data-input only-date" value="">
...
<script type="text/javascript" src="./js/guancetai/activeAnalyse_dgj.js"></script>
<script>

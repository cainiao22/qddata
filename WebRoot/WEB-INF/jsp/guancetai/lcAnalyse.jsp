...
<header>
	<nav>
		...
		<div class="tabControl">
			<a href="./lcAnalyse"><div data-type="0" class="active"><i class="qdLogo"></i>千丁App</div></a>
			<a href="./lcAnalyse_dgj"><div data-type="1"><i class="dgjLogo_n"></i>丁管家</div></a>
		</div>
	</nav>
</header>
<!--leftBar begin-->
			...
			<nav>
				<ul id="sidebar">
					...
					<li class="chose">
						...
						<a href="./lcAnalyse"><div class="level active">留存分析</div></a>
					</li>
					<li>

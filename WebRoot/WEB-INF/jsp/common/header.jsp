...
<div class="topbar">
    <div class="topbar-left">
        <div class="text-center"><a href="index.html" class="logo"><img src="./assets/img/logo.png"></a> <a
                href="index.html" class="logo-sm"><img src="./assets/img/logo.png"></a></div>
    </div>
        ...
        <div class="container">
            <div class="">
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    <%--<li class="dropdown hidden-xs"><a href="javascript:void(0)" data-target="javascript:void(0)"
                                                      class="dropdown-toggle waves-effect waves-light notification-icon-box"
                                                      data-toggle="dropdown" aria-expanded="true"> <i
                            class="fa fa-bell"></i> <span class="badge badge-xs badge-danger"></span> </a>
                    ...
                    <li class="hidden-xs"><a href="javascript:void(0)" id="btn-fullscreen"
                                             class="waves-effect waves-light notification-icon-box"><i
                            class="mdi mdi-fullscreen"></i></a></li>
                    <li class="dropdown"><a href="javascript:void(0)" class="dropdown-toggle profile waves-effect waves-light"

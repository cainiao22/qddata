                                    ...
                                    <div class="modal-body">
                                        <form id="form">
                                            <div class="form-group row">
                                                <label for="skNo" class="col-form-label col-3">skno:</label>
                                                <input type="hidden" class="form-control col-8" id="id" name="id">
                                                <input type="text" class="form-control col-8" id="skNo" name="skNo">
                                            </div>
                                            <div class="form-group row">
                                                <label for="action" class="col-form-label col-3">url/action:</label>
                                                <input type="text" class="form-control col-8" id="action" name="action">
                                            </div>
                                            <div class="form-group row">
                                                <label for="pageCode" class="col-form-label col-3">pageId:</label>
                                                <input type="text" class="form-control col-8" id="pageCode" name="pageCode">
                                            </div>
                                            <div class="form-group row">
                                                <label for="pageName" class="col-form-label col-3">页面名称:</label>
                                                <input type="text" class="form-control col-8" id="pageName" name="pageName">
                                            </div>
                                            <div class="form-group row">
                                                <label for="productId" class="col-form-label col-3">所属产品:</label>
                                                <select  class="form-control col-8" id="productId" name="productId">
                            ...
                            <div class="portlet-title">
                                <div class="row">
                                    <div class="form-group col-md-3 row">
                                        <label class="col-form-label" for="page_productId">产品：</label>
                                        <div class="input-group col-md-5">
                                            <select id="page_productId" name="page_productId">
                                                <c:forEach items="${productList }" var="list">
                                                    <option value="${list.id }">${list.name }</option>
                                                </c:forEach>
                                    ...
                                    <div class="form-group col-md-3 row">
                                        <label class="col-form-label" for="pageName">skno：</label>
                                        <div class="input-group col-md-5">
                                            <input type="text" class="form-control" name="skip_No" id="skip_No">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
...
<script>
        ...
        $('#datatable').DataTable({
            ...
            "ajax": {
                ...
                "data": function (d) {
                    ...
                    var searchParams = {};
                    if($('#page_productId').val()){
                        searchParams['productId'] = $('#page_productId').val();
                    }

                    if($('#skip_No').val()){
                        searchParams['skNo'] = $('#skip_No').val();
                    }
    ...
    function edit() {
        if(rowData){
            ...
            $('#id').val(rowData.id);
            $('#skNo').val(rowData.skNo);
            $('#action').val(rowData.action);
            $('#pageCode').val(rowData.pageCode);
            $('#pageName').val(rowData.pageName);
    ...
    $('#pageCode').change(function(){
        $.ajax({
            url: "/buriedPage/findByCode",
            type: "post",
            data:{code:$('#pageCode').val()},
            success: function (data) {
                if(data.code == 0){
                    $('#pageName').val(data.data.name);
                }
            },
            error: function (e) {
            }

                        ...
                        <div class="col-md-13">
                            <div class="portlet-title">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3 row">
                                        <label class="col-form-label" for="pageName">页面名称：</label>
                                        <div class="input-group col-md-5">
                                            <input type="text" class="form-control" name="name" id="pageName">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
...
<script>
        ...
        $('#datatable').DataTable({
            ...
            "ajax": {
                ...
                "data": function (d) {
                    ...
                    if($('#pageName').val()){
                        searchParams['name'] = $('#pageName').val();
                    }
    ...
    function exportExcel() {
        var url = "/buriedPage/export?";
        if($('#page_productId').val()){
            url += 'productId=' + $('#page_productId').val();
        }

        if($('#pageName').val()){
            url += '&name=' + $('#pageName').val();
        }
        window.open(url);
    }
    $('#paramIds').select2({
